...
/** A simple way of handling resources that needs to be closed, such as [[java.lang.AutoCloseable]].
  *
  * Source: Beginning Scala by David Pollak
  */
object WithResource {
  ...
  /** @param param of type A; passed to func
    ...
    * @return of type [[B]]
    */
  def apply[A <: { def close(): Unit }, B](param: A)(func: A => B): B =
    try {
      func(param)
    } finally {
