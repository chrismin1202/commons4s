...
object Log4jConfigurer {

  def configureLogger(logger: Logger, level: Level): Logger = {
  ...
  /** Sets/overrides the logging level for this given logger names.
    ...
    */
  def setLevels(nameLevels: Seq[(String, Level)]): Unit =
  ...
  /** Sets/overrides the logging level for this given logger names.
    ...
    * @param nameLevels the logger name and logging [[Level]] pairs
    */
  def setLevels(nameLevels: Map[String, Level]): Unit = setLevels(nameLevels.toSeq)
  ...
  /** Sets/Overrides the logging level for this given logger names.
    ...
    */
  def setLevels(nameLevel: (String, Level), more: (String, Level)*): Unit = setLevels(nameLevel +: more)
}
