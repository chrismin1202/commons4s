 ...
 */
package com.chrism.commons.cli
...
final class MissingRequiredArgumentException private[cli] (
  ...
  parsedArgs: scala.collection.Seq[String] = Seq.empty)
    extends RuntimeException("The option " + opt.delimitedOptionNames + " requires " + opt.argRange + " argument(s), " +
...
final class IncompatibleOptionsException(
  o1: CommandLineOption,
  o2: CommandLineOption,
  moreOptions: CommandLineOption*)
    extends IllegalArgumentException("The options " +
